...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("TPAY");
    case mBTC: return QString("mTPAY");
    case uBTC: return QString::fromUtf8("μTPAY");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("TrollPayCoins"));
    case mBTC: return QString(QObject::tr("Milli-TrollPayCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-TrollPayCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
